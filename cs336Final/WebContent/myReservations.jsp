...
<body>
<h4>Below are your current and passed reservations: </h4>

			<table>
			<tr>
			<td><a href=userHomePage.jsp><button>Back</button></a><td>
			<td><a href=trainSchedule.jsp><button>Make a reservation</button></a><td>
			</tr>
			</table>
...
<th onclick="sortTable(16)">Total Fare</th>
...
String sql ="select * from Reservation where username='"+ username +"' order by ScheduleDate desc";
