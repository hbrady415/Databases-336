...
<th onclick="sortTable(18)">Customer Rep</th>
...
String sql = "Select r.* FROM Reservation r inner join Login l on (r.username = l.username) Where l.firstName='"+ firstName +"' and l.lastName='"+ lastName +"'";
...
<td><%=resultSet.getString("CustomerRep") %></td>
</tr>
<%
}
connection.close();
