...
<h4>Train schedules by specific origin and destination</h4>
	...
	<form method="get" action="trainScheduleQueryCR.jsp">
	<table>
	<tr>
	<td>Origin:</td>
...
<h4>Train schedules for a given station as origin and destination</h4>

	<form method="get" action="trainScheduleQueryCR2.jsp">
	<table>
	<tr>
	<td>From Station:</td>
	        <td><select name="fromStation" size=1>
