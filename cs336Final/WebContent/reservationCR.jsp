...
<body>
<h4>Make reservation for a customer</h4>

			<table>
			<tr>
			<td><a href=trainScheduleCR.jsp><button>Check train schedules</button></a><td>
			</tr>
			</table>

<br>
	<form method="get" action="reservationCRbook.jsp">
	<table>
	<tr>
	<td>Origin:</td>
