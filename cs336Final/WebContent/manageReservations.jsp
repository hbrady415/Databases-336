...
<h4>List of reservations:</h4>
			...
			<td><a href=reservationCR.jsp><button>Make a reservation</button></a><td>
			</tr>
			</table>

<input type="text" id="myInput" onkeyup="searchable()" placeholder= "Enter a reservation ID....." title="Type in a name">
...
<th onclick="sortTable(9)">Travel Time</th>
<th onclick="sortTable(10)">Stops</th>
<th onclick="sortTable(11)">Departure Time</th>
<th onclick="sortTable(12)">Arrival Time</th>
<th onclick="sortTable(13)">Class</th>
<th onclick="sortTable(14)">Regular Tickets</th>
<th onclick="sortTable(15)">Discount Tickets</th>
<th onclick="sortTable(16)">Fare</th>
<th onclick="sortTable(17)">Total Fare</th>
...
<td><a href="reservationUpdate.jsp?reservationID=<%=resultSet.getString("reservationID")%>">Update</a></td>
<td><a href="reservationDelete2.jsp?reservationID=<%=resultSet.getString("reservationID")%>">Cancel</a></td>
</tr>
<%
}
connection.close();
