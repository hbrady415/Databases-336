...
<h4>Revenue report per Transit Line:</h4>
...
String sql = "select TransitLine, Sum(TotalFare) as Revenue from Reservation Group By TransitLine Order By Revenue desc";
