...
String sql = "select Concat(l.firstName,' ', l.lastName) as CustomerName, Sum(TotalFare) as Revenue from Reservation r inner join Login l on r.username = l.username Group By r.username order by Revenue desc Limit 1";
