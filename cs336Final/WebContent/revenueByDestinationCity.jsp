...
<h4>Revenue report per Destination City:</h4>
...
String sql = "select toStation as DestinationCity, Sum(TotalFare) as Revenue from Reservation Group By DestinationCity Order By Revenue desc";

resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr>
<td><%=resultSet.getString("DestinationCity") %></td>
