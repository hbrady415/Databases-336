...
String username = request.getParameter("passanger");
...
String sql="INSERT INTO Reservation(username, TransitLine, DepartingFrom, ArrivingTo, TrainNumber, fromStation, toStation, ScheduleDate, travelTime, Stops, DepartureTime, ArrivalTime, Class, Adults, Special, Fare, TotalFare, CustomerRep, TicketType)"
		+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
ps.setString(18, CustomerRep);
ps.setString(19, TicketType);

int i = ps.executeUpdate();
if(i > 0)
{
out.print("Reservation has been created");
}
else
{
out.print("There is a problem creating the reservation.");
}
}
