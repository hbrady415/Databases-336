...
<h4>Top 5 most active Transit Lines:</h4>
...
String sql = "Select TransitLine, Count(reservationID) as reservations from Reservation Group By TransitLine Order by reservations desc Limit 5";
...
<td><%=resultSet.getString("reservations") %></td>
</tr>
<%
}
connection.close();
